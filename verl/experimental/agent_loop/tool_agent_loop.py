...
class ToolAgentLoop(AgentLoopBase):
    ...
    async def run(self, messages: List[Dict[str, Any]], sampling_params: Dict[str, Any], tools_kwarg: Dict = None) -> AgentLoopOutput:
        ...
        while True:
            ...
            for tool_call in tool_calls[: self.max_parallel_calls]:
                tasks.append(self._call_tool(tool_call, tools_kwarg))
    ...
    async def _call_tool(self, tool_call: FunctionCall, tools_kwarg: Dict = None) -> Dict[str, str]:
        ...
        try:
            ...
            if tools_kwarg is None:
                ...
                instance_id = await tool.create(ground_truth=tools_kwarg)
