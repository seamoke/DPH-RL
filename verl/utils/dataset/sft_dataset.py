...
class SFTDataset(Dataset):
    ...
    def __init__(self, data_files: Union[str, ListConfig], tokenizer, config,processor=None):
        ...
        if not isinstance(data_files, ListConfig):
    ...
    def _download(self):
        for i, parquet_file in enumerate(self.data_files):
            self.data_files[i] = copy_to_local(parquet_file, verbose=True, use_shm=self.use_shm)
