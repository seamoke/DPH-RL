...
export EXPERIMENT_NAME=${1:-'single_32${nsample}-${NNODES}node_ray'}
export sft_loss_coeff=${2:-'0.01'}
...
if [ "$NODE_RANK" = "0" ]; then
    ...
    python -m verl.trainer.main_ppo \
       ...
       data.max_prompt_length=16000 \
        ...
        actor_rollout_ref.actor.generate_sft=True \
        actor_rollout_ref.actor.ppo_mini_batch_size=64 \
        actor_rollout_ref.actor.ppo_micro_batch_size_per_gpu=2 \
        actor_rollout_ref.actor.clip_ratio_high=0.28 \
        actor_rollout_ref.actor.sft_loss_coeff=${sft_loss_coeff} \
        actor_rollout_ref.actor.use_kl_loss=False \
        actor_rollout_ref.actor.sft_loss_mode=js_low_var \
        ...
        trainer.default_local_dir=$PROJECT_DIR/rl_models/sql_llama8b/js_low_var_coe${sft_loss_coeff} \
