...
if [ "$NODE_RANK" = "0" ]; then
    ...
    python -m verl.trainer.main_ppo \
       ...
       data.max_prompt_length=16000 \
        ...
        trainer.validation_data_dir=$PROJECT_DIR/data/sql/llama3.1-8b/generate_data/ \
        trainer.default_local_dir=$PROJECT_DIR/rl_models/llama_sql_sampling/ \
        data.train_files=$PROJECT_DIR/data/sql/bird_train.parquet \
        data.val_files=$PROJECT_DIR/data/sql/bird_train.parquet \
