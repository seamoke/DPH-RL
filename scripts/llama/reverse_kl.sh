...
if [ "$NODE_RANK" = "0" ]; then
    ...
    python -m verl.trainer.main_ppo \
       ...
       data.max_prompt_length=16000 \
        ...
        actor_rollout_ref.actor.sft_loss_mode=reverse \
        ...
        trainer.default_local_dir=$PROJECT_DIR/rl_models/sql_llama8b/grpo_reversekl_${kl_loss_coef} \
